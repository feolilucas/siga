<?php
	...
	class aluno
	{
		...
		public function mostrarum()
		{
			...
			try
			{
				$query = $conexao->conn->prepare("select TIMESTAMPDIFF(YEAR, datanascimento, CURDATE()) as idade, idaluno, nome, datanascimento, datacadastro, sexo, nomepai, nomemae,
				e.logradouro, e.numero, e.complemento, e. bairro, e.referencia, e.cidade, e.estado, e.cep, e.idendereco,
