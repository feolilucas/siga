		...
		<ul class="nav navbar-nav navbar-right">	
			<div align="right" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul align="right" class="nav navbar-nav">
					<li class="dropdown">
						<a title="<?php echo $nome ?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span></a>
						<ul class="dropdown-menu">
